...
import static edu.illinois.troup.tm.log.CrossGroupLog.RECORD_TYPE_XG_STATE_TRANSITION;
import edu.illinois.troup.tm.TID;
import edu.illinois.troup.tm.XID;
import edu.illinois.troup.tm.log.CrossGroupStateTransitionLogRecord;
